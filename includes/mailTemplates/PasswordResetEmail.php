            ...
            <section class="header-content--right">
                <nav class="header-nav" role="navigation">
                    <ul class="nav__list" aria-expanded="false">
                        <li class="list-item">
                            <a class="nav__link">Reset dien wachtwoord</a>
                        </li>
                    </ul>
                </nav>
            </section>
    ...
    <div class="content">
        <div class="block-overview">
            ...
            <div class="block-text">
                <p>Klik <a href="<?php echo $reset_link; ?>">hie</a> om dien wachtwoord te resetten.</p>
                <p>Es de link neet werkt kint geer auch deze <?php echo $reset_link; ?> in ugge browser kopiëren.</p>
                <p>PS: De link is un oer geldig</p>
                <p>Groet,</p>
